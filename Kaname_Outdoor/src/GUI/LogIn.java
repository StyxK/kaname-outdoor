...
public class LogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("");
        jLabel1.setIcon(new ImageIcon((new ImageIcon("D:\\kaname-outdoor\\pic\\logo.png").getImage().getScaledInstance(241,84,Image.SCALE_DEFAULT))));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        login.setMail(jTextField1.getText());
